...
const WebsiteName = env.WEBSITE_NAME;
          ...
          <Section style={coverSection}>
            <Section style={imageSection}>
              <Img
                ...
                width='64'
                height='64'
                alt={`${WebsiteName}'s Logo`}
              />
            </Section>
            <Section style={upperSection}>
              <Heading style={h1}>Verify your email address</Heading>
              <Text style={mainText}>
                Thanks for starting the new {WebsiteName} account creation
            ...
            <Section style={lowerSection}>
              <Text style={cautionText}>
                {WebsiteName} will never email you and ask you to disclose or
                verify your password, credit card, or banking account number.
              </Text>
            </Section>
          </Section>
          <Text style={footerText}>
            This message was produced and distributed by {WebsiteName}, Inc.,
            410 Terry Ave. North, Seattle, WA 98109. © 2022, {WebsiteName},
            Inc.. All rights reserved. {WebsiteName} is a registered trademark
            of{' '}
